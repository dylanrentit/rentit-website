    ...
    <section className="section-pad">
      <div className="container-xy text-center">
        ...
        <div className="mt-6 flex justify-center gap-3">
          <a href="/pre-release" className="rounded-full bg-brand-600 text-white px-5 py-2 font-semibold shadow-card hover:bg-brand-700 transition">Join pre-release</a>
